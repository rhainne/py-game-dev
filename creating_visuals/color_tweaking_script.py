...
def create_scales(height):
    red_scale_surface = pygame.surface.Surface((1280, height))
    green_scale_surface = pygame.surface.Surface((1280, height))
    blue_scale_surface = pygame.surface.Surface((1280, height))
    for x in range(768):
        c = int((x/639.)*255.)
        red = (c, 0, 0)
        green = (0, c, 0)
