...
def valid_space(shape, grid):
    # Repasa estos one liners. Están simplificando la lista, para convertirla 
    # en una lista de tuplas en lugar de una lista de listas de tuplas.
...
def draw_window(surface, grid, score=0, last_score=0):
    ...
    # Last score
    label = font.render('Max Score: ' + last_score, 1, (255, 255, 255))
...
def main(surface):
    ...
    while run:
        ...
        if level_time/1000 > 5:
            level_time = 0
            if fall_speed > 0.12:
                fall_speed -= 0.003 # Juega con este valor para la dificultad
        ...
        if change_piece:
            ...
            # Las siguientes tres lineas no estaban indentadas y eso causaba
            # que los colores se volvieran locos cuando la pieza tocaba fondo
            # Además la pieza siguiente mostrada no correspondía con la que
            # realmente aparecía.
        ...
        if check_lost(locked_positions):
            draw_text_middle(surface, "You Lost!", 80, (240, 240, 240))
            pygame.display.update()
